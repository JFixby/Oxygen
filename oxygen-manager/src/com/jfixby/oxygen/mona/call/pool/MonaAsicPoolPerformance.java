...
package com.jfixby.oxygen.mona.call.pool;
...
public class MonaAsicPoolPerformance implements Pool {

	public static final String API_CALL = "https://asicpool.info/index.php";
...
// L.d("data", data);
					...
					if (i == 3) {
						...
						final SpeedMagnitude order = SpeedMagnitude.GHpS;
						final Speed speed = Speed.newValue(KhashesPsec, order);
						user.speed = speed;

					}
					if (i == 4) {
						user.coinsPerDay = ShitCoin.newCoin(Double.parseDouble(data.replaceAll(",", "")), CoinSign.MONA);
					}
					if (i == 5) {
