...
package com.jfixby.oxygen.vtc.call.pool;
...
public class VTCPoolPerformance implements Pool {
	public static final String API_CALL = "https://vertcoin.miningpoolhub.com/index.php";
...
// L.d("data", data);
					...
					if (i == 4) {
						user.coinsPerDay = ShitCoin.newCoin(Double.parseDouble(data.replaceAll(",", "")), CoinSign.VERTCOIN);
					}
					if (i == 5) {
