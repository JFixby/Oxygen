...
package com.jfixby.oxygen.zec.call.pool.copy;
...
public class ZECPoolPerformance implements Pool {
	public static final String API_CALL = "https://zcash.miningpoolhub.com/index.php";
...
// L.d("data", data);
					...
					if (i == 3) {
						...
						final SpeedMagnitude order = SpeedMagnitude.MHpS;
						final Speed speed = Speed.newValue(hashesPsec, order);
						user.speed = speed;

					}
					if (i == 4) {
						user.coinsPerDay = ShitCoin.newCoin(Double.parseDouble(data.replaceAll(",", "")), CoinSign.ZCASH);
					}
					if (i == 5) {
