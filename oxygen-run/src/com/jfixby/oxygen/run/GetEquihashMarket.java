...
public class GetEquihashMarket {

	public static void main (final String[] args) throws IOException {
		ScarabeiDesktop.deploy();
		SystemSettings.setExecutionMode(ExecutionMode.DEMO);
		final NicehashOrders market = GetNicehashMarket.getOrders(Algo.EQUIHASH, Region.resolve("EU"), SpeedMagnitude.MHpS);
		L.d("nicehash", market.result.orders);

		final Ticker btcdcr = GetTicker.get(CoinSign.ZCASH);
