...
public class GetDecredMarket {

	public static void main (final String[] args) throws IOException {
		ScarabeiDesktop.deploy();
		SystemSettings.setExecutionMode(ExecutionMode.DEMO);
		final NicehashOrders market = GetNicehashMarket.getOrders(Algo.DECRED, Region.resolve("EU"), SpeedMagnitude.THpS);
...
// final BTCUSD btcUsd = btcusdProvider.getRate();
...
// L.d("belowOrEqualTarget", fork1.belowOrEqualTarget);
		...
		L.d("Pool performance", pool.perFlowUnitX24H());
		L.d("          in BTC", btcdcr.toBTC(pool.perFlowUnitX24H().coinsX24H()));
